document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showError(field, message) {
      ...
      const parent = field.closest('.form-group, .field-wrapper') || field.parentNode;
    ...
    function validateField(field) {
      ...
      for (let i = 0; i < rules.length; i++) {
        ...
        if (validators[ruleName]) {
          const isValid = validators[ruleName](field.value, ruleParam);
          if (!isValid) {
    ...
    function getValidatableFields() {
      return Array.from(contactForm.querySelectorAll(
    ...
    contactForm.addEventListener('blur', function (e) {
      ...
      if (!field || !contactForm.contains(field)) return;
      validateField(field);
    }, true);
  ...
  function initScrollAnimations() {
    ...
    elements.forEach(function (el, index) {
      ...
      const delay = el.dataset.delay || (index % 5) * 80;
    ...
    if ('IntersectionObserver' in window) {
      ...
      function checkVisibility() {
        ...
        elements.forEach(function (el) {
          ...
          const visiblePoint = elementTop + rect.height * 0.1;

          if (scrollTop + windowHeight > visiblePoint) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '12d82bb2-ba82-4887-8f60-35c793039de0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '12d82bb2-ba82-4887-8f60-35c793039de0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '12d82bb2-ba82-4887-8f60-35c793039de0';
